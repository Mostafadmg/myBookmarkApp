...
</svg>`},x=[{value:"recently-added",label:"Recently added"},{value:"recently-visited",label:"Recently visited"},{value:"most-visited",label:"Most visited"}];function $(){return`
<section class="cards">
...
`}function L(){return x.map(e=>{const t=i.selectedSort===e.value;return`
...
`}).join("")}function v(){return j().map(t=>{const r=`cardmenu-panel-${t.id}`,a=t.isArchived?`<button class="cardmenu__item" role="menuitem" type="button" data-action="open-unarchive-confirm">
    ${d.unarchive}
    <span>Unarchive</span>
</button>`:`<button class="cardmenu__item" role="menuitem" type="button" data-action="open-archive-confirm">
    ${d.archiveSmall}
    <span>Archive</span>
</button>`,o=`<button class="cardmenu__item" role="menuitem" type="button" data-action="delete-modal-open">
    ${d.delete}
    <span>Delete</span>
...
`}function q(){const e=V();return Object.entries(e).map(([t,r])=>{const a=i.selectedTags.includes(t);return`
<li class="sidebar__tagItem ${a?" is-selected":""}" role="checkbox" data-action="filter-tag" aria-checked="${a?" true":"false"}" data-tag="${t}">
...
`}).join("")}function _(e){return`https://www.google.com/s2/favicons?domain=${new URL(e).hostname}&sz=64`}function T(){const e=document.querySelector(".addbookmark__input"),t=document.querySelector(".addbookmark__textarea"),r=document.getElementById("addbookmark-url-input"),a=document.getElementById("addbookmark-tags-input");let o=!0;return!e||!t||!r||!a?void 0:([{input:e,validate:s=>s.trim()!==""},{input:t,validate:s=>s.trim()!==""},{input:r,validate:s=>{try{return new URL(s),!0}catch{return!1}}},{input:a,validate:s=>s.trim()!==""}].forEach(({input:s,validate:c})=>{c(s.value)?D(s):(E(s),o=!1)}),o)}function g(){const e=document.querySelector(".addbookmark__input"),t=document.querySelector(".addbookmark__textarea"),r=document.getElementById("addbookmark-url-input"),a=document.getElementById("addbookmark-tags-input");if(!T())return;const n=M({title:e.value,description:t.value,url:r.value,tags:a.value.split(",").map(c=>c.trim()).filter(c=>c!==""),favicon:_(r.value)}),s=i.bookmarks.find(c=>c.id===i.editingBookmarkId);s?(s.title=e.value,s.description=t.value,s.url=r.value,s.tags=a.value.split(",").map(c=>c.trim()).filter(c=>c!==""),s.favicon=_(r.value)):i.bookmarks.push(n),u(),p()}function p(){const e=document.querySelector(".addbookmark__input"),t=document.querySelector(".addbookmark__textarea"),r=document.getElementById("addbookmark-url-input"),a=document.getElementById("addbookmark-tags-input");e.value="",t.value="",r.value="",a.value="",i.editingBookmarkId=null,document.querySelectorAll(".addbookmark__field").forEach(o=>o.classList.remove("error"))}function E(e){e.closest(".addbookmark__field").classList.add("error")}function D(e){e.closest(".addbookmark__field").classList.remove("error")}function Z(){return`
    ...
    `}function l(e,t){const r=document.querySelector(e);if(r){if(!t){const a=r.querySelector(":focus");a&&a.blur()}r.setAttribute("data-state",t?"open":"closed"),r.setAttribute("aria-hidden",String(!t)),t?r.removeAttribute("inert"):r.setAttribute("inert","")}}function P(){const e=i.theme==="light"?"is-active":"",t=i.theme==="dark"?"is-active":"",r=i.theme==="light",a=i.theme==="dark";return`
...
${C()}
  ...
  `;e.innerHTML=t}function f(){const e=i.theme,t=document.documentElement;e==="light"?t.setAttribute("data-theme","light"):t.setAttribute("data-theme","dark"),U(e)}function U(e){const t=document.querySelector('[data-action="set-theme-light"]'),r=document.querySelector('[data-action="set-theme-dark"]');if(!t||!r)return;const a=e==="light";t.classList.toggle("is-active",a),t.setAttribute("aria-pressed",String(a)),r.classList.toggle("is-active",!a),r.setAttribute("aria-pressed",String(!a))}function O(){const e=document.querySelector(".accountmenu__panel"),t=document.querySelector("[data-action='toggle-accountmenu']");e&&(t.classList.toggle("active"),e.classList.toggle("open"))}function h(e){i.isMobileSidebarOpen=e;const t=document.querySelector(".sidebar");if(t){if(!e){const a=t.querySelector(":focus");a&&a.blur()}t.classList.toggle("open",e),t.setAttribute("aria-hidden",String(!e)),e?t.removeAttribute("inert"):t.setAttribute("inert","")}else w();const r=document.querySelector('[data-action="toggle-sidebar"]');r&&r.setAttribute("aria-expanded",String(e))}function R(){document.addEventListener("click",e=>{const t=e.target.closest("[data-action]")?.dataset.action,r=e.target.closest("[data-action]");if(G(e),!!t){if(t==="toggle-sidebar"&&h(!0),t==="close-sidebar"&&h(!1),t==="toggle-accountmenu"&&O(),t==="set-theme-light"&&(i.theme="light",f()),t==="set-theme-dark"&&(i.theme="dark",f()),t==="addbookmark"&&l(".addbookmark",!0),t==="close-addbookmark"&&(l(".addbookmark",!1),p()),t==="cancel-addbookmark"&&(l(".addbookmark",!1),p()),t==="sort"&&F(),t==="toggle-cardmenu"&&r.closest(".cardmenu").querySelector(".cardmenu__panel").classList.toggle("open"),t==="set-sort"){document.querySelectorAll("[data-action='set-sort']").forEach(s=>{s.classList.remove("is-active")}),r.classList.add("is-active");const o=r.dataset.sortValue;i.selectedSort=o;const n=document.querySelector(".cards__container");n.innerHTML=v()}if(t==="save-addbookmark"&&(l(".addbookmark",!1),g()),t==="filter-tag"){const a=r.dataset.tag;i.selectedTags.includes(a)?i.selectedTags=i.selectedTags.filter(o=>o!==a):i.selectedTags.push(a),u()}if(t==="visit-bookmark"){const a=r.closest("[data-bookmark-id]").dataset.bookmarkId,o=i.bookmarks.find(s=>s.id===a);o.visitCount++,o.lastVisited=Date.now();const n=o.url;window.open(n,"_blank"),u()}if(t==="copy-bookmark-url"){const a=r.closest("[data-bookmark-id]").dataset.bookmarkId,o=i.bookmarks.find(s=>s.id===a);if(!o)return;const n=o.url;navigator.clipboard.writeText(n).then(()=>{r.querySelector("span").textContent="Copied",setTimeout(()=>{r.querySelector("span").textContent="Copy URL"},2e3)})}if(t==="toggle-pin-bookmark"){const a=r.closest("[data-bookmark-id]").dataset.bookmarkId,o=i.bookmarks.find(n=>n.id===a);o.pinned=!o.pinned,u()}if(t==="edit-bookmark"){const a=r.closest("[data-bookmark-id]").dataset.bookmarkId,o=i.bookmarks.find(b=>b.id===a);l(".addbookmark",!0);const n=document.querySelector(".addbookmark__input"),s=document.querySelector(".addbookmark__textarea"),c=document.getElementById("addbookmark-url-input"),y=document.getElementById("addbookmark-tags-input");n.value=o.title,s.value=o.description,c.value=o.url,y.value=o.tags,i.editingBookmarkId=a,document.querySelectorAll(".addbookmark__field").forEach(b=>b.classList.remove("error"))}if(t==="open-archive-confirm"){const a=r.closest("[data-bookmark-id]").dataset.bookmarkId;i.archivingBookmarkId=a,l(".bookmarkconfirm--archive",!0)}if(t==="close-archive-confirm"&&l(".bookmarkconfirm--archive",!1),t==="cancel-archive-confirm"&&l(".bookmarkconfirm--archive",!1),t==="archive-bookmark"){const a=i.bookmarks.find(o=>o.id===i.archivingBookmarkId);a.isArchived=!0,l(".bookmarkconfirm--archive",!1),u(),i.archivingBookmarkId=null}if(t==="navigate-home"&&(i.activeView="main",h(!1),u()),t==="navigate-archived"&&(i.activeView="archive",h(!1),u()),t==="close-delete-confirm"&&l(".bookmarkconfirm--delete",!1),t==="cancel-delete-confirm"&&l(".bookmarkconfirm--delete",!1),t==="delete-modal-open"){l(".bookmarkconfirm--delete",!0);const a=r.closest("[data-bookmark-id]").dataset.bookmarkId;i.deletingBookmarkId=a}if(t==="delete-bookmark"){const a=i.deletingBookmarkId;I(a),l(".bookmarkconfirm--delete",!1)}if(t==="open-unarchive-confirm"){l(".bookmarkconfirm--unarchive",!0);const a=r.closest("[data-bookmark-id]").dataset.bookmarkId;i.unarchivingBookmarkId=a}if(t==="unarchive-bookmark"){const a=i.unarchivingBookmarkId,o=i.bookmarks.find(n=>n.id===a);o.isArchived=!1,u(),l(".bookmarkconfirm--unarchive",!1)}t==="cancel-unarchive-confirm"&&l(".bookmarkconfirm--unarchive",!1),t==="close-unarchive-confirm"&&l(".bookmarkconfirm--unarchive",!1)}}),document.addEventListener("submit",e=>{const t=e.target;t instanceof HTMLFormElement&&(t.matches(".addbookmark__form")&&(e.preventDefault(),g()),t.matches(".authmodal__form")&&e.preventDefault())}),document.addEventListener("input",e=>{i.searchQuery=document.getElementById("header__input").value,u()})}function F(){document.querySelector(".sortmenu__panel").classList.toggle("open")}const N=[{container:".accountmenu",panel:".accountmenu__panel"},{container:".sortmenu",panel:".sortmenu__panel"},{container:".cardmenu",panel:".cardmenu__panel"},{container:".sidebar",panel:".sidebar"}];function G(e){N.forEach(({container:t,panel:r})=>{const a=document.querySelector(r);a&&!e.target.closest(t)&&a.classList.contains("open")&&a.classList.remove("open")})}async function Q(){await H(),w(),R()}Q();
//# sourceMappingURL=index-Cx9ozPCS.js.map
